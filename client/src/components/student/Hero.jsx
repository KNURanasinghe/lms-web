  ...
  return (
    <div className="flex flex-col items-center justify-center w-full pt-20 text-center md:pt-36 px-7 md:px-0 space-y-7 bg-gradient-to-b from-cyan-100/70">
      ...
      <p className="hidden max-w-2xl mx-auto text-gray-500 md:block">
        We bring together world-clas instructors, interactive content, and a
        sipportive community to help you acheive your personal and professional
        goals.
      </p>
      <p className="max-w-sm mx-auto text-gray-500 md:hidden">We bring together world-class instructors to help you acheive your professional goals.</p>
      <SearchBar/>
    </div>
  );
};
