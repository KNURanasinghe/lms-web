...
const TestimonialSection = () => {
  return (
    <div className='px-8 pb-14 md:px-0'>
      ...
      <p className='mt-3 text-gray-500 md:text-base'>Hear from our leanears as they share their journey of transformation, success, and how our <br />
      platform has made a difference in their lives.</p>
      
      <div className='grid gap-8 grid-cols-auto mt-14 '>
        {dummyTestimonial.map((testimonial, index)=>(
          <div key={index} className='pb-6 text-sm text-left bg-white border rounded-lg shadow-[0px_4px_15px_0px] overflow-hidden shadow-black/5 border-gray-500/30'>
