...
const CourseDetails = () => {
  ...
  const {allCourses,calculateRating, calculateChapterTime, calculateCourseDuration, calculateNumberOfLecture} = useContext(AppContext)
  ...
  return courseData ? (
    ...
    <div className='relative flex flex-col-reverse items-start justify-between gap-10 px-8 pt-20 text-left md:flex-row md:px-36 md:pt-30'>
      ...
      <div className='z-10 max-w-xl text-gray-500'>
        <h1 className='font-semibold text-gray-800 md:text-course-deatails-heading-large text-course-deatails-heading-small '>{courseData.courseTitle }</h1>
        ...
        {/* review and rating */}
         <div className='flex items-center space-x-2'>
                ...
                <p className='text-sm'>Course by <span className='text-blue-600 underline'>KNURanasinghe</span></p>
